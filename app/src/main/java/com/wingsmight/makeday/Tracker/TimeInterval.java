...
{
    private int day, month, year, hoursBefore, minutesBefore, hoursAfter, minutesAfter;

    public TimeInterval(int day, int month, int year, int hoursBefore, int minutesBefore, int hoursAfter, int minutesAfter)
    {
        this.day = day;
        this.month = month;
        this.year = year;
