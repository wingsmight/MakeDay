...
public class DragNDropGoalListView extends ListView
{
	boolean mDragMode;
	...
	public DragNDropGoalListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	private void startDrag(int itemIndex, int y)
    {
        ...
        TextView goalName = item.findViewById(R.id.goalName);
        goalName.setTextColor(getContext().getResources().getColor(android.R.color.tab_indicator_text));
